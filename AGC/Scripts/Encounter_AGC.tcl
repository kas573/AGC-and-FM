...
#  Created on Wed Dec  2 23:20:52 2020                
#                                                     
#######################################################
...
set init_verilog ../Outputs/TYP_CORNER/AGC_Top_synth.v
set init_mmmc_file ../Source/MMMC_AGC_regs.tcl
set init_io_file ../Source/AGC_pins
set init_pwr_net VDD
#Design initializing
init_design
#Specifying floorplan
floorPlan -site core_hd -r 0.9795675756 0.699999 10.08 10.37 10.08 10.37
...
#Verifications
setVerifyGeometryMode -area { 0 0 0 0 } -minWidth true -minSpacing true -minArea true -sameNet true -short true -overlap true -offRGrid false -offMGrid true -mergedMGridCheck true -minHole true -implantCheck true -minimumCut true -minStep true -viaEnclosure true -antenna false -insuffMetalOverlap true -pinInBlkg false -diffCellViol true -sameCellViol false -padFillerCellsOverlap true -routingBlkgPinOverlap true -routingCellBlkgOverlap true -regRoutingOnly false -stackedViasOnRegNet false -wireExt true -useNonDefaultSpacing false -maxWidth true -maxNonPrefLength -1 -error 1000 -report ../Reports/Layout/Verify/AGC.geom.rpt
verifyGeometry
setVerifyGeometryMode -area { 0 0 0 0 }
verify_drc -report ../Reports/Layout/Verify/AGC.drc.rpt -limit 1000
verifyConnectivity -type all -report ../Reports/Layout/Verify/AGC.conn.rpt -error 1000 -warning 50
#SignOff
...
write_sdf  ../Outputs/Layout/AGC.sdf
saveNetlist ../Outputs/Layout/AGC_TOP_netlist.v
saveNetlist ../Outputs/Layout/AGC_netlist_Phys.v -includePhysicalCell {FEED7HD FEED5HD FEED3HD FEED2HD FEED25HD FEED1HD FEED15HD FEED10HD DECAP7HD DECAP5HD DECAP3HD DECAP25HD DECAP15HD DECAP10HD}
global dbgLefDefOutVersion
set dbgLefDefOutVersion 5.8
defOut -floorplan -netlist -routing ../Outputs/Layout/AGC.def
set dbgLefDefOutVersion 5.8
saveDesign ../Outputs/Layout/AGC.enc
