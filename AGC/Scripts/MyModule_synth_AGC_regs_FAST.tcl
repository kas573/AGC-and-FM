...
include ../Scripts/X-FAB_FAST_AGC.tcl
## Setup variables
set DESIGN AGC
set PARAMS {}
...
report area > ../Reports/Synthesis/FAST_CORNER/FAST_Top_synth_area_report_AGC
report timing > ../Reports/Synthesis/FAST_CORNER/FAST_Top_synth_timing_report_AGC
## Write out synthesized Verilog netlist
write_hdl -mapped > ../Outputs/Synthesis/FAST_CORNER/FAST_AGC_Top_synth.v
## Write out the SDC file we will take into the place n route tool
write_sdc > ../Outputs/Synthesis/FAST_CORNER/FAST_AGC_Top_out.sdc
gui_show
