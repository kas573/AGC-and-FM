...
include ../Scripts/X-FAB_FAST_FM.tcl
## Setup variables
...
report area > ../Reports/Synthesis/FAST_CORNER/FAST_Top_synth_area_report_FM
report timing > ../Reports/Synthesis/FAST_CORNER/FAST_Top_synth_timing_report_FM
## Write out synthesized Verilog netlist
write_hdl -mapped > ../Outputs/Synthesis/FAST_CORNER/FAST_FM_Top_synth.v
## Write out the SDC file we will take into the place n route tool
write_sdc > ../Outputs/Synthesis/FAST_CORNER/FAST_FM_Top_out.sdc
gui_show
