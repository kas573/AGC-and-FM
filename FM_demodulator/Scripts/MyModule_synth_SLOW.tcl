...
include ../Scripts/X-FAB_SLOW_FM.tcl
## Setup variables
...
report area > ../Reports/Synthesis/SLOW_CORNER/SLOW_Top_synth_area_report_FM
report timing > ../Reports/Synthesis/SLOW_CORNER/SLOW_Top_synth_timing_report_FM
## Write out synthesized Verilog netlist
write_hdl -mapped > ../Outputs/Synthesis/SLOW_CORNER/SLOW_FM_Top_synth.v
## Write out the SDC file we will take into the place n route tool
write_sdc > ../Outputs/Synthesis/SLOW_CORNER/SLOW_FM_Top_out.sdc
gui_show
